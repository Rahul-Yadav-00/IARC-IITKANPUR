...
//          for(int i=0;i<4;i++)
//          {
//              display_number=display_number*10+arr[i];
////              Serial.print(display_matrix);
//          }
//          Serial.print(display_number);
//          itoa(display_number,arr,4);
//          Serial.println("");
          Serial.write(arr,4);
          delay(1000); N 
//      Serial.println("");
...
//        analogWrite(EN_R,122);
//        analogWrite(EN_L,132);
//         Serial.print(digitalRead(IR_3));
//      Serial.print(digitalRead(IR_4));
////      Serial.println("");
//      Serial.print(digitalRead(IR_8));
